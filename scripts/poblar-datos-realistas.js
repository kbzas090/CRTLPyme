            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    _loop_1 = function (tenant) {
                        var tenantType, businessType, adminUser, createdProducts, _b, _c, product, masterProduct, tenantInventory, movementsCount, productsWithStock, _d, productsWithStock_1, inventory, entryDate, additionalEntries, i, entryAmount, entryDate_1, salesCount, tenantRevenue, months, saleNumber, _e, months_1, month, _loop_2, i;
                        return __generator(this, function (_f) {
                            switch (_f.label) {
                                case 0:
                                    console.log("\n\uD83D\uDCE6 Procesando: ".concat(tenant.businessName));
                                    console.log("   Tipo de negocio: ".concat(TENANT_TYPE_MAP[tenant.businessName] || 'desconocido'));
                                    tenantType = TENANT_TYPE_MAP[tenant.businessName];
                                    if (!tenantType) {
                                        console.log("   \u26A0\uFE0F  Tipo de negocio no encontrado, saltando...");
                                        return [2 /*return*/, "continue"];
                                    }
                                    businessType = BUSINESS_CATALOG[tenantType];
                                ...
                                case 3:
                                    masterProduct = _f.sent();
                                    _f.label = 4;
                                case 4: return [4 /*yield*/, prisma.tenantInventory.create({
                                        data: {
                                            tenantId: tenant.id,
                                ...
                                case 6:
                                    ...
                                    return [3 /*break*/, 1];
                                case 7:
                                    console.log("   \u2705 ".concat(createdProducts.length, " productos creados"));
                                    ...
                                    _f.label = 8;
                                case 8:
                                    if (!(_d < productsWithStock_1.length)) return [3 /*break*/, 14];
                                ...
                                case 9:
                                    ...
                                    _f.label = 10;
                                case 10:
                                    if (!(i < additionalEntries)) return [3 /*break*/, 13];
                                ...
                                case 14:
                                    ...
                                    _f.label = 15;
                                case 15:
                                    if (!(_e < months_1.length)) return [3 /*break*/, 20];
                                    month = months_1[_e];
                                    _loop_2 = function (i) {
                                    ...
                                    _f.label = 16;
                                case 16:
                                    if (!(i < month.sales)) return [3 /*break*/, 19];
